...
public class PushNotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pushnotification_activity);
    ...
    sharedPreferences.edit().putString(SharedPreferenceConstants.fcm_reg_id, regId).apply();
    Intent intent=new Intent(PushNotificationActivity.this,SplashScreen.class);

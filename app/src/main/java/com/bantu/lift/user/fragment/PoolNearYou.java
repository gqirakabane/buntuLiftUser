...
public class PoolNearYou extends Fragment implements View.OnClickListener ,AdapterCallback {
    ...
    public static PoolNearYou newInstance(double mParam1, double mParam2, double mParam3, double mParam4, String amount, String carId, String luggage, String passenger,String preferanceType) {
        PoolNearYou fragment = new PoolNearYou();
    ...
    public void getPoll()
    {
        ...
        Call<GetPollsModelclass> signInModelclassCall = iRestInterfaces.getPolls(sharedPreferences.getString(SharedPreferenceConstants.serviceKey,""), sharedPreferences.getString(SharedPreferenceConstants.userId,""),String.valueOf(mParam1),String.valueOf(mParam2),String.valueOf(mParam3),String.valueOf(mParam4),mParam8,mParam6,mParam7,"",mParam5,mParam9,start_date);
            ...
            public void onResponse(Call<GetPollsModelclass> call, Response<GetPollsModelclass> response) {
                if (response.isSuccessful()) {
                    ...
                    if (status_val == 0) {
                        ...
                        poolnearYouAdapter = new PoolnearYouAdapter(getContext(),data,PoolNearYou.this);
